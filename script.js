const NUM_OF_TIMERS = 6;  // total number of timers
...
const ALARMS = ["", "default", "default", "default", "default", "default", "default"];

// Array of labels for input form. Works similarly to ALARMS.
// If no label is provided, the label is blank
const LABELS = ["", "Planning/Minor Actions", "Movement, Rank 1", "Movement, Rank 2", "Movement, Rank 3", "Movement, Rank 4", "Movement, Water Rank"];
...
function turnOnForm() {
  ...
  document.getElementById("master-reset").style.display = 'none';
}
